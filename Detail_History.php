...
<meta charset="UTF-8">
    ...
    <title>Kabupaten-Detail History</title>
...
<body>
    ...
    <section class="formulir" style="margin-top: 7em;">
        <form class="container">
            ...
            <div class="logo text-center" style="margin-left: 200px;">
                <img src="image\detailhistory.png" class= "mt-lg-5 " alt="">
            </div>
            <div class="form-row mt-lg-5">
                <div class="form-group col-md-4">
                    <label for="inputNamaPetugas">Nama Petugas</label>
                    <input type="text" class="form-control" id="inputNamaPetugas" placeholder="Nama Petugas">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
