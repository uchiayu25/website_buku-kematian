                ...
                <span class="border-three">
                    <div class="menu_box mt-2">
                        <div class="menu-detail">
                            ...
                            <div class="menu_detail-ox">
                                <p>Akun pengguna dusun yang baru didaftarkan wajib diverifikasi terlebih dahulu sebelum dapat melakukan penginputan laporan.</p>
                            </div>
                        </div>
                    </div>
                </span>
                <span class="border-four mr-3">
                    <div class="menu_box mt-2">
                        <div class="menu-detail">
                            ...
                            <div class="menu_detail-ox">
                                <p>Penambahan dusun atau lingkungan baru yang hanya dapat ditambahkan oleh desa</p>
                            </div>
                        </div>
                    </div>
                </span>
